...
$route['(?i)flight/departure/delete/(:any)'] = 'Flight/departureDelete/$1';
$route['(?i)flight/arrival/edit/(:any)'] = 'Flight/arrivalEdit/$1';
$route['(?i)flight/arrival/delete/(:any)'] = 'Flight/arrivalDelete/$1';
...
$route['(?i)jo/(:any)/(:any)'] = 'Endorsement/JO/$1/$2';
$route['(?i)pknew/(:any)/(:any)'] = 'Endorsement/PkNew/$1/$2';
$route['(?i)dex/(:any)/(:any)'] = 'Endorsement/Dex/$1/$2';
