  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
                            ...
                            <form class="form-horizontal form-label-left" id="frmAddTki">
                              ...
                              <div class="form-group fieldtitle">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="tkitmptkeluar" name="tkitmptkeluar" required="required" class="form-control input-sm">
                                </div>
                              </div><br /><br /><br />
                              <div class="form-group fieldtitle">
                              ...
                              <div class="form-group fieldtitle">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" name="tkitelp" required="required" class="form-control input-sm">
                                </div>
                              </div><br /><br /><br />
                              <div class="form-group fieldtitle">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" name="tkihub" required="required" class="form-control input-sm">
                                </div>
                              </div>
                            </form>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-sm btn-success" id="btnSubmitForm">Update</button>
      </div>
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    ...
                    <div class="x_content">
                      <div class="col-md-8 center-margin">
                        <form class="form-horizontal form-label-left">
                          <div class="form-group">
                            <label>PPTKIS / 仲介名稱 (*)</label>
                            <div>
                              <select class="form-control input1st input-sm" id="pptkis" toggle-dropdown>
                                <option>
                                </option>
                          ...
                          <div class="form-group">
                            <label>Job Type / 職位 (*)</label>
                            <div>
                              <select class="form-control input1st input-sm"  id="jobtype" toggle-dropdown>
                                <option></option>
                              </select>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                              <button id="next1st" class="btn btn-sm btn-success">Next</button>
                            </div>
                          </div>
                        </div>
                      </div>
                              ...
                              <ul class="nav navbar-right panel_toolbox">
                                ...
                                <div class="x_content">
                                  <div class="col-md-8 center-margin">
                                    <form class="form-horizontal form-label-left">
                                      <div class="form-group">
                                        <p><strong>Please input complete passport number (without space / " " character), and click Add :</strong></p> </br>
                                        <label class="control-label col-md-3 col-sm-2 col-xs-12" for="name">No.Passport TKI <span class="required">*</span></label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                          <input id="passport" type="text" name="passport" required="required" class="form-control input2nd input-sm">
                                        </div>
                                        <div style="margin-left: -55px;" class="col-md-4 col-sm-4 col-xs-12">
                                          <button type="button" class="btn btn-sm btn-success" id="addTKI">Add</button>
                                        </div>
                                      </div>
                                    </br></br>
                                    <p id="kuota"><i></i></p>
                                    ...
                                    <p><span style="color:#ff0000"><b>IMPORTANT</b></span>: <i>Data of Indonesian labors for your agency <b>will be shown</b> above, only if your Indonesian Agency partner <b>has input complete data</b> of the labors (including <b>passport number</b>) into system SISKOTKLN in Indonesia.</i></p>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-4 col-sm-6 col-xs-12">
                                        <button id="back2nd" class="btn btn-sm btn-default">Back</button>
                                        <button id="next2nd" class="btn btn-sm btn-success">Next</button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                      ...
                                      <ul class="nav navbar-right panel_toolbox">
                                        ...
                                        <div class="x_content">
                                          <div class="col-md-8 center-margin">
                                            <form class="form-horizontal form-label-left">
                                              <div class="form-group">
                                                <label class="control-label col-md-5 col-sm-5 col-xs-12" for="name">ID Card No. / 身分證號碼 <span class="required">*</span></label>
                                                <div class="col-md-5 col-sm-5 col-xs-12">
                                                  <input type="text" name="name" id="idno" required="required" class="input-sm form-control input3rd 3rdrequired" placeholder="33138667489">
                                                </div>
                                              </div><br /><br /><br />
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <label class="control-label col-md-5 col-sm-5 col-xs-12" for="name">地址 <span class="required">*</span></label>
                                                <div class="col-md-5 col-sm-5 col-xs-12">
                                                  <textarea name="name" required="required" id="address2" class="resizable_textarea form-control input3rd 3rdrequired ">
                                                  </textarea>
                                                </div>
                                              </div><br /><br /><br />
                                              <div class="form-group">
                                              ...
                                              <?php foreach($employer as $row): ?>
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-5 col-sm-5 col-xs-12">
                                                    <input type="text" id="<?php echo $row->fieldname ?>" class="input-sm form-control input3rd">
                                                  </div>
                                              <?php endforeach; ?>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-4 col-sm-6 col-xs-12">
                                                  <button id="back3rd" class="btn btn-sm  btn-default">Back</button>
                                                  <button id="next3rd" class="btn btn-sm btn-success">Next</button>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                                  ...
                                                  <div class="x_content" >
                                                    <div class="col-md-10 center-margin">
                                                      <form class="form-horizontal form-label-left">
                                                        ...
                                                        <div class="form-group" >
                                                          <label class="control-label col-md-5 col-sm-5 col-xs-12" for="name">CLA Recruitment Letter Date / 發文日期 <span class="required">*</span></label>
                                                          <div class="col-md-5 col-sm-5 col-xs-12">
                                                            <div class="input-group date datepicker col-md-12 col-xs-12" data-provide="datepicker" ng-class="{'has-error':(pst && shForm.inDate.$invalid)}">
                                                              ...
                                                              <input id="cladate" type="text" class="form-control tglformat input-sm" required></input>
                                                            </div>
                                                          </div>
                                                        </div><br /><br /><br />
                                                        <div class="form-group">
                                                          <label class="control-label col-md-5 col-sm-5 col-xs-12" for="name">Worker Needed / 勞工人數 <span class="required">*</span></label>
                                                          <div class="col-md-5 col-sm-5 col-xs-12">
                                                            <input type="text" readonly name="jojmltki" id="jojmltki" required="required" class="form-control input4th input-sm">
                                                          </div>
                                                        </div><br /><br /><br />
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                          <label class="control-label col-md-5 col-sm-5 col-xs-12" for="name">Notes / 備註 </label>
                                                          <div class="col-md-5 col-sm-5 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          <div class="col-md-4 col-sm-6 col-xs-12">
                                                            <button class="btn btn-default btn-sm" id="back4th">Back</button>
                                                            <button name="submit" class="btn btn-success btn-sm" id="submitpost">Submit</button>
                                                          </div>
                                                        </div>
                                                      </div>
                                                    </div>
                                      ...
                                      function editDialog(data,isEdit)
                                      {
                                        ...
                                        $("#btnSubmitForm").unbind('click').click(function(){
                                          if (formAddTki.find("input[name=tkitelp]").val() !== "" && formAddTki.find("input[name=tkijmlhanaktanggungan]").val() !== "" && formAddTki.find("input[name=tkiahliwaris]").val() !== "" && formAddTki.find("input[name=tkinama2]").val() !== "" && formAddTki.find("input[name=tkitelp]").val() !== "") {
                                            ...
                                            window.alert('Make sure all data is filled!');
                                          }});
                                        }
