    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_content checked" style="display: none" >
        <div class="row" style="padding-top: 20px">
          ...
          <div class="col-md-12">
            <div class="col-md-2">
              <label class="control-label" >PKP Code:</label>
            </div>
            <div class="col-md-10">
              <p id="jopkpkode"></p>
            </div>
  ...
  $(document).ready(function () {
    ...
    $("#legalize").click(function() {
      ...
      if (confirms == true)
      {
        lv.ladda('start');
        var code = $("#barcode").val();
        $.post("<?php echo base_url()?>jo/legalizeBarcode", {barcode: code}, function(data,status){
          lv.ladda('stop');
          var obj = $.parseJSON(data);
          if(obj) {
              $(".checkedk").show();
            ...
            alert('JO already has been legalized before!');
          }
        });
      }
    });
