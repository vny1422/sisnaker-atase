...
<p style="font-size:8pt; padding-left:-7 mm; margin-top:-3mm;"><?= $pk['agnama'];?></p>
<p style="font-size:8pt; padding-left:14 mm; margin-top:3mm;"><?= $row1;?></p>
<p style="font-size:8pt; padding-left:-7 mm; margin-top:10mm;"><?= $row2;?></p>
<p style="font-size:8pt; padding-left:-7 mm; margin-top:16mm;"><?= $pk['agtelp'];?>&emsp;<?= $pk['agfax'];?></p>
<p style="font-size:8pt; padding-left:-7 mm; margin-top:23mm;">Agency's MOL License Number : <?= $pk['agnoijincla'];?></p>
...
<p style="padding-left:19 mm; margin-top:205mm; font-family:sun-extA;"><?= $pk['tkalmtcn2'];?></p>
...
<p style="padding-left:107 mm; margin-top:45mm;"><?= $pk['jomkthn'];?></p>
<p style="padding-left:120 mm; margin-top:45mm;"><?= $pk['jomkbln'];?></p>
<p style="padding-left:128 mm; margin-top:45mm;">_<?= $pk['jomkhr'];?>_</p>

<p style="padding-left:80 mm; margin-top:66mm;"><?= $pk['jomkthn'];?></p>
<p style="padding-left:99 mm; margin-top:66mm;"><?= $pk['jomkbln'];?></p>
<p style="padding-left:112 mm; margin-top:66mm;">_<?= $pk['jomkhr'];?>_</p>
...
<p style="padding-left:0 mm; margin-top:20mm;"><?= $row1; ?><br><?= $row2;?><br><?= $pk['agtelp'];?>&emsp;<?=  $pk['agfax'];?></p>
...
<p style="padding-left:93 mm; margin-top:20mm;"><?= $row1; ?><br><?= $row2;?><br><?= $pk['pptelp'];?>&emsp;<?=  $pk['ppfax'];?></p>
