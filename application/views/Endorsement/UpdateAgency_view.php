    ...
    <?php endif; ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="email" value="<?php echo $values->agemail ?>" required="required" class="form-control input-sm">
            </div>
        </div><br /><br /><br />
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Agency Name <span class="required">*</span></label>
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="name" value="<?php echo $values->agnama ?>" required="required" class="form-control input-sm" readonly>
            </div>
        </div><br /><br /><br />
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="nameother" value="<?php echo $values->agnamaoth ?>" required="required" class="form-control input-sm" readonly>
            </div>
        </div><br /><br /><br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="noijin" value="<?php echo $values->agnoijincla ?>" required="required" class="form-control input-sm" readonly>
            </div>
        </div><br /><br /><br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="address" value="<?php echo $values->agalmtkantor ?>" required="required" class="form-control input-sm">
            </div>
        </div><br /><br /><br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="addressother" value="<?php echo $values->agalmtkantoroth ?>" required="required" class="form-control input-sm">
            </div>
        </div><br /><br /><br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="penanggung" value="<?php echo $values->agpngjwb ?>" required="required" class="form-control input-sm">
            </div>
        </div><br /><br /><br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="penanggungother" value="<?php echo $values->agpngjwboth ?>" required="required" class="form-control input-sm">
            </div>
        </div><br /><br /><br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="notelp" value="<?php echo $values->agtelp ?>" required="required" class="form-control input-sm">
            </div>
        </div><br /><br /><br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" name="nofax" value="<?php echo $values->agfax ?>" required="required" class="form-control input-sm">
            </div>
        </div><br /><br /><br />
        <div class="ln_solid"></div>
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <button type="reset" name="cancel" class="btn btn-primary btn-sm">Cancel</button>
