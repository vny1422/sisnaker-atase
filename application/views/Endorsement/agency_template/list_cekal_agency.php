...
<table st-table="cekalagencies" st-safe-src="cekalagencies_q" class="table table-condensed table-hover table-bordered">
    <thead>
        ...
        <tr class="text-center">
            <th></th>
            <th><input st-search="agnama" placeholder="nama agensi" class="input-sm form-control" /></th>
            <th><input st-search="agpngjwb" placeholder="penanggung jawab" class="input-sm form-control" /></th>
            <th><input st-search="castart" placeholder="awal cekal" class="input-sm form-control" /></th>
            <th><input st-search="caend" placeholder="akhir cekal" class="input-sm form-control" /></th>
        </tr>
    </thead>
