  ...
  <div class="row">
                    ...
                    <div class="col-xs-12">
                      <form class="form-horizontal" method="post" id="thisform">
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control input-sm" name="nama" placeholder="ex: $dian → diawali 'dian'">
                          </div>
                          <label class="col-sm-1 control-label">No. Paspor</label>
                          <div class="col-sm-3">
                            <input type="text" class="form-control input-sm" name="paspor">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-1 control-label">Asal</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control input-sm" name="asal">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-1 control-label">Wilayah Kerja</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control input-sm" name="wilayahkerja" placeholder="">
                          </div>
                          <label class="col-sm-1 control-label">Pekerjaan</label>
                          <div class="col-sm-3">
                            <input type="text" class="form-control input-sm" name="kerja">
                          </div>
                        </div>
                        <div class="form-group">
                          <button type="submit" class="btn btn-primary col-sm-1 col-sm-offset-2 input-sm"><i class="fa fa-search-plus"></i> Cari</button>
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="panel-body" >
                      <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active" id="tbendorse">
                          <div class="col-xs-12" >
                            <table id="dtable" class="table table-condensed table-hover">
                              <thead>
                                <tr>
    ...
    var Modal = {
      modalData : function (refs) {
        ...
        //rquest
        var req="<?=base_url('datatki/query_detail')?>";
