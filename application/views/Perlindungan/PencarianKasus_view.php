        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="col-xs-12" style="padding-top: 20px" class=" table-responsive">
              <table st-table="queries" st-safe-src="query_result" class="table table-hover table-condensed" ng-hide="query_result.length==0">
                <thead>
                  <tr>
                  ...
                  <tr class="btn-info">
                    <th>
                      <input st-search="namatki" placeholder="Filter NAMA" class="input-sm-sm form-control" type="search"/>
                    </th>
                    <th>
                      <input st-search="paspor" placeholder="Filter PASPOR" class="input-sm-sm form-control" type="search" style="margin-bottom: 5px"/>
                      <select st-search="statustki" class="input-sm-sm form-control" type="search">
                    ...
                    <th style="<?php echo ($_SESSION['role'] == 1 || $_SESSION['role'] == 5 ? "" : "display:none;"); ?>" >
                      <input st-search="namainstitusi" placeholder="Filter INSTITUSI" class="input-sm-sm form-control" type="search"/>
                    </th>
                    <th>
                      <input st-search="jenispekerjaan" placeholder="Filter PEKERJAAN" class="input-sm-sm form-control" type="search"/>
                    </th>
                    <th>
                      <input st-search="klasifikasi" placeholder="Filter KLASIFIKASI" class="input-sm-sm form-control" type="search"/>
                    </th>
                    <th>
                      <input st-search="tanggalpengaduan" placeholder="Filter TANGGAL" class="input-sm-sm form-control" type="search"/>
                    </th>
                    <th>
                      <input st-search="petugas" placeholder="Filter PETUGAS" class="input-sm-sm form-control" type="search"/>
                    </th>
                    <th>
                      <select st-search="statusmasalah" class="input-sm-sm form-control" type="search" style="margin-bottom: 5px; width:100px">
                        <option value="">-- Semua --</option>
                  ...
                  <tr class="btn-primary">
                    ...
                    <th class="col-lg-2">Klasifikasi</th>
                    <th class="col-lg-1">Tgl Pengaduan</th>
                    <th class="col-lg-1">Petugas</th>
                    <th class="col-lg-1">Status Masalah</th>
                  </tr>
                </thead>
...
function popupMasalah(problemID){
  ...
  function(data){
    ...
    $("#Anamacurrency").text(("Nominal Yang Diselamatkan " + obj[0].currencyname + " :"));
