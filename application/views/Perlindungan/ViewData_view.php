    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="tableproses">
                          <thead>
                            <tr class="btn-danger">
                              ...
                              <th class="text-center col-lg-2">Jenis Pekerjaan</th>
                              <th class="text-center col-lg-2">Petugas</th>
                              <th class="text-center col-lg-1">Interval</th>
                              <th class="text-center col-lg-1">Tanggal Aduan</th>
                            </tr>
                          </thead>
                          <tbody class="table-hover">
                            <?php $i = 1; foreach ($kasusproses->result() as $row ) { ?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $row->tanggalpengaduan ?></td>
                              </tr>
                              <?php $i++; }?>
                            </tbody>
                          </table>
        ...
        <script type="text/javascript">
          <?php if ($tab2 == 1) { ?>
            $("#tabskasus a:last").tab('show');
            <?php } else {?>
              $("#tabskasus a:first").tab('show');
              <?php }?>
