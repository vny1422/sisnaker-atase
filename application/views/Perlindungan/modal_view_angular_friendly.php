				 	...
				 	<div class="modal-dialog modal-lg">
				    	<div class="modal-content">
				      		<div class="modal-header">
			                    ...
			                    <button type="button" class="btn btn-success btn-sm pull-right" id="Adownloadform" value="177777">
			                ...
			                <form action="" class="form-horizontal">
				                <div class="modal-body">
		                			...
		                			<div class="panel panel-default">
										...
										<div class="form-group">
											<label id="Anamacurrency" for="inputtglmasuktw" class="col-sm-3 control-label"></label>
											<div class="col-sm-4">
				                ...
				                <div class="modal-footer">
				                    ...
				                    <button type="button" class="btn btn-primary btn-sm" id="editkasus">
				                    	<i class="fa fa-pencil"></i> <strong>Edit</strong>
				                    </button>
				                    <button type="button" class="btn btn-danger btn-sm" id="delkasus" ng-click="delKasus()">
