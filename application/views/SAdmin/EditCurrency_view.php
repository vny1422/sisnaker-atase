                    ...
                    <div class="right_col" role="main">
                        ...
                        <?php echo form_open(base_url('currency/edit/'.$values->idcurrency)) ?>

                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">Name <span class="required">*</span></label>
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <input type="text" name="name" value ="<?php echo $values->currencyname ?>" required="required" class="form-control">
                            </div>
                        </div><br /><br /><br />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <input type="number" name="kurs" value ="<?php echo $values->kurs ?>" required="required" class="form-control">
                            </div>
                        </div><br /><br /><br />
