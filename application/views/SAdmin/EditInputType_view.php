                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <?php echo form_open(base_url('inputtype/edit/'.$values->idinputtype)) ?>

                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">Name <span class="required">*</span></label>
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    <input type="text" value="<?php echo $values->nameinputtype ?>" name="name" required="required" class="form-control">
                                </div>
                            </div><br />
