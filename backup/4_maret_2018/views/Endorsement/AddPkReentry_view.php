...
<div class="right_col" role="main">
  ...
  <div class="row" >
    <div class="col-md-12 col-sm-12 col-xs-12">
      <h3 style="text-align: center;"><strong>Create Reentry Hiring (Labour Contract)</strong></h3>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <div class="x_content">
                        <div class="col-md-8 center-margin">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3" for="name">Apakah dengan bantuan PPTKIS?<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <div style="margin-top: -0.1em" class="radio">
                                <span style="margin-left: 5%; color: black;">
                                  <input type="radio" name="bantuanpp" value="1" checked> Ya &nbsp
                                </span>
                                <span style="margin-left: 5%; color: black;">
                                  <input type="radio" name="bantuanpp" value="0"> Tidak
                                </span>
                              </div>
                            </div>
                          </div><br /><br /><br />
                          <div class="form-group">
                            <label class="control-label col-md-3" for="name">Apakah TKI pulang dahulu ke Indonesia?<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <div style="margin-top: -0.1em" class="radio">
                                <span style="margin-left: 5%; color: black;">
                                  <input type="radio" name="tkipulang" value="1" checked> Ya &nbsp
                                </span>
                                <span style="margin-left: 5%; color: black;">
                                  <input type="radio" name="tkipulang" value="0"> Tidak
                                </span>
                              </div>
                            </div>
                          </div><br /><br />
                                    ...
                                    <form class="form-horizontal form-label-left">
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                          <input type="text" readonly name="name" id="idno" required="required" class="form-control input3rd 3rdrequired">
                                        </div>
                                      </div><br /><br /><br />
                                      <div class="form-group">
                                        <label class="control-label col-md-5 col-sm-5 col-xs-12" for="name">Company / Employer Name <span class="required">*</span></label>
                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                          <input type="text" readonly name="tesad" required="required" id="employer" class="form-control input3rd 3rdrequired">
                                        </div>
                                      </div><br /><br /><br />
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                          <input type="text" readonly name="name" id="pngjwb2" class="form-control input3rd">
                                        </div>
                                      </div><br /><br /><br />
                                      <?php foreach($employer as $row): ?>
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-5 col-sm-5 col-xs-12">
                                            <input type="text" readonly id="<?php echo $row->fieldname ?>" class="form-control input3rd">
                                          </div>
                                        </div><br /><br /><br />
                                      <?php endforeach; ?>
                              ...
                              $(document).ready(function() {
                                ...
                                $("#submitpost").click(function(e){
                                  ...
                                  var postdata = {
                                    ...
                                    jenispk:1,
                                    bantuanpp: $('input[name=bantuanpp]:checked').val(),
                                    backtoid: $('input[name=tkipulang]:checked').val()
                                  };
