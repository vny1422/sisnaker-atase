...
-- Dumping structure for table db_daerah.kabupaten
...
-- Dumping data for table db_daerah.kabupaten: ~514 rows (approximately)
...
-- Dumping structure for table db_daerah.provinsi
...
-- Dumping data for table db_daerah.provinsi: ~34 rows (approximately)
